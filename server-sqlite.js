...
app.use(helmet());
app.use(cors({
    origin: ['http://localhost:3001', 'http://127.0.0.1:3001', 'http://localhost:3001/', 'http://127.0.0.1:3001/', 'http://localhost:8000', 'http://127.0.0.1:8000', 'http://localhost:8000/', 'http://127.0.0.1:8000/'],
    credentials: true,
...
app.post('/api/auth/register-barber', async (req, res) => {
    try {
        ...
        await runQuery(
            'INSERT INTO barbers (user_id, specialty, rating, earnings) VALUES (?, ?, ?, ?)',
            [result.id, specialty || 'General', 4.5, 0]
        );
...
app.get('/barber-dashboard', (req, res) => {
    res.sendFile(path.join(__dirname, 'barber-dashboard.html'));
});
...
app.get('/barber-portal', (req, res) => {
    res.sendFile(path.join(__dirname, 'barber-portal.html'));
});

app.get('/barber-registration', (req, res) => {
    res.sendFile(path.join(__dirname, 'barber-registration.html'));
});

app.get('/barber-directory', (req, res) => {
    res.sendFile(path.join(__dirname, 'barber-directory.html'));
});
